...
export class AppComponent implements OnDestroy {
  ...
  categorias = [
    {
      nombre: 'Comida',
      foto: '/src/assets/images/restaurantes.png'
    },
    {
      nombre: 'Salud',
      foto: '/src/assets/images/salud.png'
    },
    {
      nombre: 'Automotriz',
      foto: '/src/assets/images/autos.png'
    },
    {
      nombre: 'Tiendas',
      foto: '/src/assets/images/tiendas.png'
    },
    {
      nombre: 'Directorio de servicios',
      foto: '/src/assets/images/emergencias.png'
    },
    {
      nombre: 'Otros',
      foto: '/src/assets/images/otros.png'
    },
  ];
  menuGeneral = true;
  menuAccount = false;
