...
const routes: Routes = [
  {
    ...
    component: AppComponent,
        children: [
          ...
          { path: 'ficha-bazar/:categoria/:id', loadChildren: './contenido/ficha-bazar/ficha-bazar.module#FichaBazarPageModule' },
          { path: 'preguntas', loadChildren: './contenido/preguntas/preguntas.module#PreguntasPageModule' },
          { path: 'ficha-empleo', loadChildren: './contenido/ficha-empleo/ficha-empleo.module#FichaEmpleoPageModule' },
        ]
      },
