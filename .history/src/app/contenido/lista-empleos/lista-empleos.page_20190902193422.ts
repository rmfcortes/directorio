...
import { FichaEmpleoPage } from './ficha-empleo/ficha-empleo.page';
import { EmpleosFormPage } from '../empleos-form/empleos-form.page';
...
export class ListaEmpleosPage implements OnInit {
  ...
  async detallesAnuncio(clasificado) {
