...
export class FavoritosPage implements OnInit {
  ...
  goDetalles(negocio) {
    if (negocio.categoria === 'bazar') {
      this.detallesAnuncio(negocio, 'bazar');
    } else if (negocio.categoria === 'inmuebles') {
      this.detallesAnuncio(negocio, 'inmuebles');
    } else if (negocio.categoria === 'empleos') {
      this.detallesEmpleo(negocio);
    }
  }

  async detallesAnuncio(anuncio, clas) {
    const modal = await this.modalController.create({
  ...
  async detallesEmpleo(clasificado) {
    const modal = await this.modalController.create({
