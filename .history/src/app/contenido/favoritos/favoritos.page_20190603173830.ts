...
export class FavoritosPage implements OnInit {
  ...
  async borrarFavorito(negocio) {
    ...
    try {
      ...
      console.log(this.respaldoFavoritos[this.categoria].length);
      delete this.respaldoFavoritos[this.categoria][negocio.id];
      console.log(this.respaldoFavoritos);
      console.log(this.respaldoFavoritos[this.categoria]);
      console.log(this.respaldoFavoritos[this.categoria].length);
      console.log(this.respaldoFavoritos[this.categoria] === {});
      console.log(this.respaldoFavoritos[this.categoria] === null);
      console.log(this.respaldoFavoritos[this.categoria] === undefined);
      if (this.respaldoFavoritos[this.categoria] === {}) {
        const y = this.categorias.indexOf(this.categoria);
        this.categorias.slice(y, 1);
        this.detalles = false;
      }
      this.loader.dismiss();
      if (!resp) {
