...
export class FavoritosPage implements OnInit {
  ...
  goDetalles(negocio) {
    ...
    if (negocio.categoria === 'Bazar') {
      this.router.navigate(['/ficha-bazar', negocio.categoria.toLowerCase(), negocio.id, negocio.subCategoria]);
    } else if (negocio.categoria === 'Inmuebles') {
      this.router.navigate(['/ficha-bazar', negocio.categoria.toLowerCase(), negocio.id]);
