...
import { Pregunta, Pasillo, Producto, Calificacion, Negocio, PrevDataNegocio, ResultNegocio, Valoraciones, ComentarioVistaPrevia } from 'src/app/interfaces/negocio.interface';
...
export class FichaNegocioPage implements OnInit {
  ...
  getCantidadValoraciones() {  ///////////////// corregir esto
