...
export class ListaProductosPage {
  ...
  emptyCart() {
    ...
    this.productos.forEach(producto => {
      if (producto.cantidad) { delete producto.cantidad; }
      if (producto.index) { delete producto.index; }
      if (producto.total) { delete producto.total; }
      if (producto.cart) { delete producto.cart; }
    });
    this.closeCart();
  }
