...
const routes: Routes = [
  {
    path: '',
        ...
        children: [
          ...
          {
            path: 'calificar/:categoria/:id/:calificacion',
          ...
          { path: 'bazar-form', loadChildren: './bazar-form/bazar-form.module#BazarFormPageModule' },
          { path: 'empleos-form', loadChildren: './empleos-form/empleos-form.module#EmpleosFormPageModule' },
          { path: 'inmuebles-form', loadChildren: './inmuebles-form/inmuebles-form.module#InmueblesFormPageModule' },
