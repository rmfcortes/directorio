...
export class MapaPage implements OnInit {
  ...
  setAutocomplete() {
    this.mapsAPILoader.load().then(async () => {
      // const nativeHomeInputBox = document.getElementById('txtHome').getElementsByTagName('searchbar-input')[0];
      const autocomplete = new google.maps.places.Autocomplete(await this.searchbar.getInputElement(), {
        types: ['address']
    });
