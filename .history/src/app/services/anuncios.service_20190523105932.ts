...
export class AnunciosService {
  ...
  getAnuncioBazar(uid, id) {
    return this.db.object(`usuarios/${uid}/anuncios/bazar/${id}`).valueChanges();
  }

  getAnuncioEmpleo(uid, id) {
    return this.db.object(`usuarios/${uid}/anuncios/empleos/${id}`).valueChanges();
  }
