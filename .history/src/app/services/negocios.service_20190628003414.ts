...
import { Pregunta, Pasillo, Producto, ResultNegocio, PrevDataNegocio } from '../interfaces/negocio.interface';
...
export class NegociosService {
  ...
  getValoracionesMuestra(id) {
    return new Promise((resolve, reject) => {
      const valSub = this.db.list(`solo-lectura/negocios/valoraciones/${id}`, val => val.orderByKey().limitToLast(3))
        .valueChanges().subscribe(valoraciones => {
