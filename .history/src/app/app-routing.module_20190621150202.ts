...
const routes: Routes = [
  {
    ...
    component: AppComponent,
        children: [
          ...
          { path: 'pasillo/:id/:pasillo',
            loadChildren: './contenido/lista-pasillos/lista-pasillos.module#ListaPasillosPageModule'
          },
          { path: 'productos/:id/:pasillo/:categoria',
            loadChildren: './contenido/lista-productos/lista-productos.module#ListaProductosPageModule'
          },
          {
            path: 'mapa/:lat/:lng',
